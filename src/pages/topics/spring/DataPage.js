...
const DataPage = () => {
    ...
    const getTopicIcon = (topicTitle) => {
        switch (topicTitle) {
            case 'Database Access Evolution in Java':
            case 'Spring Data JPA Components':
                return <Database className="w-4 h-4" />;
            case 'Query Types':
                return <Code className="w-4 h-4" />;
            case 'Entity Relationships and Fetch Types':
                return <Layers className="w-4 h-4" />;
            case 'Entity Lifecycle':
                return <GitMerge className="w-4 h-4" />;
            case 'Transaction Management':
                return <Shield className="w-4 h-4" />;
            case 'Common Problems and Optimizations':
                return <Settings className="w-4 h-4" />;
            case 'Testing Spring Data Applications':
    ...
    const getSectionIcon = (title) => {
        ...
        if (lowerTitle.includes('component')) return <Package className="w-4 h-4 text-orange-400" />;
        if (lowerTitle.includes('query')) return <Filter className="w-4 h-4 text-indigo-400" />;
        if (lowerTitle.includes('comparison')) return <Table className="w-4 h-4 text-blue-400" />;
        if (lowerTitle.includes('practice')) return <Edit className="w-4 h-4 text-green-400" />;
    ...
    const getActiveTopic = () => {
        return springData.topics?.find(topic => topic.title === activeTopic);
    };
